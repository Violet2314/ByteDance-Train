...
import { Globe, Zap, Activity, Lock, BarChart3, Crosshair, Cpu, Signal } from 'lucide-react'
...
export default function AdvantagesSection() {
  ...
  return (
    <section id="solutions" ref={horizontalSectionRef} className="h-screen bg-[#0B0F19] relative overflow-hidden flex items-center font-mono">
      ...
      <div ref={rightFadeRef} className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-white/10 to-transparent z-20 pointer-events-none" />
      ...
      <div ref={cardsContainerRef} className="flex gap-8 px-24 items-center h-full w-max relative z-10">
          ...
          >
            ...
            <div className="relative h-full p-8 flex flex-col">
              ...
              <div className="mt-auto">
                <div className="text-[10px] text-[#74B868] mb-2 tracking-widest">{feature.subtitle}</div>
                ...
                <div className="pt-4 border-t border-white/5 flex justify-between items-center">
                   ...
                   <span className="text-xs font-bold text-white group-hover:text-[#74B868] transition-colors">{feature.tech_spec}</span>
                </div>
              </div>
            </div>
          </motion.div>
