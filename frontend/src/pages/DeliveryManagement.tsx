...
export default function DeliveryManagement() {
  ...
  }, [activeRuleId, rules, isMapReady]) // Re-run when active rule changes
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <Tag
                color="blue"
                className="rounded-full border-0 bg-blue-50 text-blue-600 font-bold"
              >
          ...
          <div className="flex-1 overflow-auto p-4">
              ...
              columns={[
                ...
                },
                {
                  ...
                  render: (_, r) => (
                    <span>
                      {r.recipient.name}{' '}
                      <span className="text-gray-400 text-xs">{r.recipient.phone}</span>
                    </span>
                  ),
                },
                {
            ...
            {deliverableOrders.length === 0 && (
              <div className="text-center py-8 text-gray-400 text-sm">当前区域内暂无匹配订单</div>
            )}
          </div>
        </motion.div>
      </div>
